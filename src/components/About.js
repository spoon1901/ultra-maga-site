...
About</h2>
        <p className="text-xl sm:text-3xl md:text-4xl lg:text-2xl text-white">
          ...
          <br /><br />
          Today, $MAGA isn't just a meme, it's a signal. A movement. A message of strength and sovereignty that speaks far beyond borders.
          <br /><br />
          This isn't just about America anymore. It's about freedom for all. A global stand against control, and a rally cry for those who still believe in power to the people.
          <br /><br />
          Collaborations, airdrops, and utility are already in the works and some have already begun.
          <br /><br />
          This is holder-powered. Future-built. And just getting started.
        </p>
      </div>
    </section>
  );
